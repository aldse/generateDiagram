...
const Alert = ({ type, title, description, onRemove, index, isExiting }) => {
  ...
  return (
    <div
      className={`${styles.alert} ${styles[`alert--${alertTypeClass}`]} ${
        isExiting ? styles.exiting : styles.entering
      }`}
    >
      <div className={styles["alert-icon"]}>{renderIcon()}</div>
      <div className={styles["alert-content"]}>
        <div
          className={styles["alert-content-title"]}
          style={{
            color:
        ...
        <div
          className={styles["alert-content-description"]}
          style={{
            color:
              alertTypeClass === "error"
                ? "red"
